...
const favBreakfast: string = 'Waffles';
const favLunch: string = "Sandwich";
const favDinner: string = "Steak"
;
...
const myPerson: Person = {
  id: 33,
  name: 'Andrew Rentschler',
  skills: [{ name: 'Cooking', learned: true }],
}
...
const feedPerson = (favBreakfast: string, favLunch: string, favDinner: string, myPerson: Person): void => {
  myPerson.meals = myPerson.meals
...
const teachPerson = (myPerson: Person, skills: Skill[]): void => {
  myPerson.skills = [...myPerson.skills, ...skills]
}
...
const getRandomSkill = (myPerson: Person): Skill => {
  let randomSkill = myPerson.skills[Math.floor(Math.random() * myPerson.skills.length)]
  return randomSkill
}
